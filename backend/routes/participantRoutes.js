...
import { createParticipation, getParticipantsByEvent, getAllParticipants, getParticipantById, checkDuplicateParticipant } from '../controllers/participantControllers.js';
...
router.post('/participants/check-duplicate', checkDuplicateParticipant);
